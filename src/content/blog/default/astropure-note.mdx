...
**内容过时且无效，该笔记已经隐藏。如果您通过查看仓库看到了这篇文章，别看**


> 记录一下构建新博客站的过程、自定义功能需求和 bug 的解决，以及在这个过程中了解到的一些 js 相关的知识。参考资料：[pure 主题文档](https://astro-pure.js.org/docs)、[astro 文档](https://docs.astro.build/en/getting-started/)。我并没有系统学习 js 及其专有名词，很多内容也是自己折腾半天、大模型生成、勉强理解之后写的，未经过专业的考证。如果您有相关的专业知识，欢迎评论详细说明。
***
