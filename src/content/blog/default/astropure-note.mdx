...
***
起因：知乎上刷到一个[关于个人博客的回答](https://www.zhihu.com/question/29755481/answer/1939008272137957420)，看到了这个博客 https://arthals.ink/ ，很喜欢这种干净整洁的画面，而且还是个开源项目。再加上使用 hexo + shoka 的旧站非常卡，很多功能都不完善，维护起来很麻烦。于是启动了这次搬家。
