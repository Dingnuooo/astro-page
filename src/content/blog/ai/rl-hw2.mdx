...
heroImage: { src: './RL/hw2-frozenlake.png', color: '#6eb8dd' }
---
...
import q1_1 from './RL/hw2-q1-1.png'

<Image src={q1_1} width={300} alt="hw2-q1-1" />
...
import img2 from './RL/hw2-q1-2.png'

<Image src={img2} width={300} alt="hw2-q1-2" />
...
import img3 from './RL/hw2-frozenlake.png'

<Image src={img3} width={400} alt="hw2-frozenlake" />
